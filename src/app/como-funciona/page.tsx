...
export default function ComoFuncionaElite() {
  const faqItems = [
    {
      q: 'Como os anfitriões são avaliados?',
      a: 'Analisamos documentos, antecedentes e realizamos uma entrevista técnica. Apenas 15% são aprovados.',
    },
    {
      q: 'Posso visitar o anfitrião antes?',
      a: 'Sim! Encorajamos o pré-encontro para que o pet se familiarize com o ambiente.',
    },
    {
      q: 'E se o anfitrião cancelar?',
      a: 'Realocamos seu pet com um cuidador de elite ou devolvemos 100% do valor imediatamente.',
    },
    {
      q: 'O que acontece em emergências médicas?',
      a: 'Levamos ao veterinário mais próximo e nossa equipe de suporte acompanha tudo em tempo real.',
    },
    {
      q: 'Como são definidos os preços?',
      a: 'Cada anfitrião define seu valor baseado em sua experiência e infraestrutura.',
    },
    {
      q: 'O local é seguro contra fugas?',
      a: 'Sim, auditamos fotos e vídeos para garantir que o local seja totalmente telado e seguro.',
    },
    {
      q: 'Receberei notícias do meu pet?',
      a: 'Com certeza! É regra receber fotos e vídeos diários da rotina e bem-estar do seu amigo.',
    },
    {
      q: 'Quem fornece a ração?',
      a: 'O dono deve fornecer a ração e as instruções de dieta para evitar problemas digestivos.',
    },
    {
      q: 'O pagamento é seguro?',
      a: 'O valor fica retido pelo PetHub e só é liberado ao anfitrião após o término da hospedagem.',
    },
    {
      q: 'Como entro em contato com o suporte?',
      a: 'Temos um chat prioritário dentro da plataforma e canais de emergência 24h por dia.',
    },
  ];
    ...
    <div className="min-h-screen bg-white text-black font-sans selection:bg-purple-200">
      ...
      <section className="pt-20 pb-16 px-6 border-b-[8px] border-black">
        <div className="max-w-5xl mx-auto">
          <div className="flex gap-2 mb-6">
            <span className="bg-purple-600 text-white border-2 border-black px-3 py-1 font-black uppercase text-[10px]">
              Segurança em Primeiro Lugar
            </span>
            <span className="bg-white border-2 border-black px-3 py-1 font-black uppercase text-[10px] italic">
              Transparência Total
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl font-bold text-gray-600 max-w-3xl leading-relaxed italic">
            Criamos um ecossistema onde a confiança não é uma opção, mas a base de tudo. Do processo de seleção rigoroso ao
            suporte em tempo real, cada detalhe foi pensado para que você viaje com paz de espírito.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5 space-y-6">
            <h2 className="text-4xl font-black uppercase italic leading-none">
              Como selecionamos <br /> nossos anfitriões?
            </h2>
            ...
            <p className="font-bold text-gray-500 leading-relaxed">
              Nosso processo é manual e rigoroso. Não basta ter um espaço, é preciso ter alma de cuidador e infraestrutura
              adequada.
            </p>
          </div>
            ...
            {[
              {
                ...
                d: 'Validamos documentos oficiais e antecedentes de cada anfitrião.',
              },
              ...
              <div
                key={i}
                className="bg-white border-4 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all"
              >
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-black uppercase text-center mb-16 italic border-b-4 border-black w-fit mx-auto pb-2">
            O Ciclo PetHub
          </h2>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <p className="font-bold text-gray-300">
                  Cobertura de despesas veterinárias emergenciais durante a hospedagem para imprevistos de saúde.
                </p>
              </div>
              <div className="flex gap-4">
          ...
          <div className="border-[6px] border-white p-10 bg-gray-900 shadow-[15px_15px_0px_0px_rgba(147,51,234,1)]">
            ...
            <p className="font-bold text-sm text-gray-400 leading-relaxed mb-6 italic">
              O valor da sua reserva fica retido com o PetHub. O anfitrião só recebe o pagamento após o pet retornar para você e
              confirmarmos que tudo correu bem.
            </p>
      ...
      <footer className="py-32 px-6 text-center bg-purple-600 text-white border-t-[8px] border-black">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center max-w-2xl mx-auto">
          <Link
            href="/search"
            className="flex-1 bg-black text-white p-6 border-4 border-black font-black uppercase text-2xl shadow-[8px_8px_0px_0px_rgba(255,255,255,0.4)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all"
          >
            BUSCAR ANFITRIÃO
          </Link>
          <Link
            href="/quero-cuidar"
            className="flex-1 bg-white text-black p-6 border-4 border-black font-black uppercase text-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all"
          >
            QUERO HOSPEDAR
          </Link>
        </div>
